...
### Question 2a
Questions 2a focus at the East room and uses $TiE$ as input variable $yTi$ and $TiW$ as target variable $Tn$.

The script `fitmodel.R` has been implemented step by step in the following sections.

#### 1. Step

Figure \ref{fig_ex_2_1} shows 

```{r, fig.cap="\\label{fig_ex_2_1}Plot of the simulation realizations with sigma = 0.0."}
